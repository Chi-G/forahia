...
class Cart extends Component {
     ...
     if(response.data===1){
          cogoToast.success("Product Order Removed Successfully",{position:'top-right'}); 
          this.setState({PageRefreshStatus:true})   
     }else{
          cogoToast.error("Request not added, try again!",{position:'top-right'});
     }
          }).catch(error=>{
               cogoToast.error("Request not added, try again!",{position:'top-right'});
     ...
     axios.post(AppURL.CartOrder, MyFormData).then(response =>{
          ...
          if(response.data===1){
               cogoToast.success("Your Order Request was Received Successfully",{position:'top-right'}); 
                      ...
                      <div className="card-body">
                        <div className="container-fluid ">
                          ...
                          <div className="col-md-12 p-1 col-lg-12 col-sm-12 col-12">
                              ...
                              <option value="Nigeria">Aba</option>
                              <option value="Nigeria">Enugu</option>
                              <option value="Nigeria">Ebonyi</option>
                              <option value="Nigeria">Rivers</option>
                              <option value="Nigeria">Akwa Ibom</option>
                              </select>
                          </div>
                          <div className="col-md-12 p-1 col-lg-12 col-sm-12 col-12">
