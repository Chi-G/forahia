            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('all-product') }}"><i class="bx bx-home-alt"></i></a></li>
                         ...
                         <div class="border border-3 p-4 rounded">
                            <div class="row g-3">
                               ...
                               <div class="col-12">
                                 ...
                                 <option value="{{ $item->subcategory_name }}" selected="" id="sub-category">Select SubCategory</option>
                               ...
                               <div class="col-12">
                                  ...
                                  <input type="text" name="brand" value="{{ $product->brand }}" class="form-control" id="inputBrand" placeholder="Product Brand">                                  
                               </div>
